...
export class ArrowTable {
  ...
  public getCell = (rowIndex: number, columnIndex: number): Cell => {
    ...
    if (isColumnsCell) {
      ...
      return {
        type: "columns",
        classNames: `col_heading level${rowIndex} col${dataColumnIndex}`,
    ...
    if (isIndexCell) {
      ...
      return {
        ...
        classNames: `row_heading level${columnIndex} row${dataRowIndex}`,
    ...
    return {
      ...
      classNames: `data row${dataRowIndex} col${dataColumnIndex}`,
      content,
    };
  };
